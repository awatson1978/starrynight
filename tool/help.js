module.exports = function () {
  ...
  console.log( "Usage:" );
  console.log( "  fetch" );
  console.log( "  autoconfig --nightwatch" );
  console.log( "  run-tests --type <testType> --env <environment> --tag <tag>" );
  console.log( "  run-tests --framework <frameworkName> --autogenerated" );
  console.log( "  generate-release-json" );
  console.log( "  generate-application-json --name <applicationName>" );
